...
const AUTH_URL = "https://accounts.spotify.com/authorize?client_id=8d028dc7fb1741a5affeae86686969fe&response_type=token&redirect_uri=http://https://cs484spotifygames.pages.dev//&scope=user-read-private%20user-read-email%20user-top-read%20user-library-read%20playlist-read-private%20user-read-recently-played";
